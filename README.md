...
**Note: You may need to set your execution policy for it to run smoothly. To do so open an elevated powershell session and run ``` Set-ExecutionPolicy RemoteSigned ``` **
